...
{
    // m_pWidget->windowFlags() should be the same as m_windowFlags,
    // otherwise it will lead to a crash for setParent_sys;
    // make sure your frameless widget's parent widget is mainwindow.
