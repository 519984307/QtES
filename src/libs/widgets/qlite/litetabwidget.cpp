...
LiteTabWidgetPrivate::LiteTabWidgetPrivate() :
    m_tabBar(nullptr), m_stack(nullptr), m_layout(nullptr), q(nullptr), m_pos(LiteTabWidget::North)
{}
...
LiteTabWidget::LiteTabWidget(QWidget *parent) : LiteWidget(parent), d(new LiteTabWidgetPrivate())
{
    d->q = this;
    d->init();
}
